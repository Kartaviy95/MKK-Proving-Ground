...
`allowDamage`-защита занятой техники на машине-владельце объекта, динамически
защищенная очистка ACE medical/hearing/fire/flashbang/G-Forces и Advanced
Fatigue состояний и экранных эффектов без обязательной ACE-зависимости;
player_ace — блокировка ACE medical damage для режима бога через wound handler;
