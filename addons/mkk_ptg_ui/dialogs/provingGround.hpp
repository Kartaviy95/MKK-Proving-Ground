class MKK_PTG_MainDisplay {
    ...
    movingEnable = 1;
    enableSimulation = 1;
    onLoad = "_this call mkk_ptg_fnc_initDisplay";
    ...
    class controls {
        class SearchEdit: MKK_PTG_RscEdit {
            ...
            h = 0.04;
            text = "";
            onKeyUp = "[] call mkk_ptg_fnc_refreshVehicleList";
        };
        ...
        class SideCombo: MKK_PTG_RscCombo {
            ...
            w = 0.16;
            h = 0.04;
            onLBSelChanged = "[] call mkk_ptg_fnc_refreshVehicleList";
        };
        ...
        class VehicleList: MKK_PTG_RscListbox {
            ...
            w = 0.38;
            h = 0.64;
            onLBSelChanged = "_this call mkk_ptg_fnc_onVehicleSelected";
        };
        ...
        class SpawnBtn: MKK_PTG_RscButton {
            ...
            h = 0.04;
            text = "Spawn Empty";
            action = "[false] call mkk_ptg_fnc_onSpawnPressed";
        };
        ...
        class SpawnCrewBtn: MKK_PTG_RscButton {
            ...
            action = "[true] call mkk_ptg_fnc_onSpawnPressed";
        };
        ...
        class StaticTargetBtn: MKK_PTG_RscButton {
            ...
            action = "[player] remoteExecCall ['mkk_ptg_fnc_spawnStaticTarget', 2]";
        };
        ...
        class InfantryTargetBtn: MKK_PTG_RscButton {
            ...
            action = "[player] remoteExecCall ['mkk_ptg_fnc_spawnInfantryTarget', 2]";
        };
        ...
        class CleanupBtn: MKK_PTG_RscButton {
            ...
            h = 0.04;
            text = "Cleanup Range";
            action = "[] call mkk_ptg_fnc_onCleanupPressed";
        };
        ...
        class RefreshBtn: MKK_PTG_RscButton {
            ...
            h = 0.04;
            text = "Refresh";
            action = "[] call mkk_ptg_fnc_refreshFilters";
        };
