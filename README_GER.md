...
- `ptg_ui` - Hauptfenster, Startmenue, kleine Zusatzfenster fuer Einstellungen, Fahrzeug-Erstellungsbildschirm, Fahrer+Schuetze-Modus, Kamera, Teleport, Kartenrauch und Karten-Timings, Wiederbewaffnung, Testziele, HUD-Einstellungen, Hitpoint-Inspektor, Interface-Skalierung und Button-Handler.
- `ptg_spawn` - globales Spawnen von Fahrzeugen, Fahrern/Besatzungen, Testzielen und Kartenrauch-Markierungen, Registrierung erstellter Objekte, Loeschen und Aufraeumen des Testplatzes ohne Pflicht, das Addon auf einem Dedicated Server zu laden.
...
- Kartenrauch: Farbauswahl im Dashboard und globaler Smoke-Shell mit Spielernamen-Marker per Alt+LMB auf der geoeffneten Karte;
